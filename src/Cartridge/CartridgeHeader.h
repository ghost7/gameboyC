...
public:
    ...
    uint8_t oldLicenseCode; //!< The old license code.
     ...
     */
    CartridgeHeader(uint8_t *rawRom);
     ...
     */
    static std::string getGameTitle(uint8_t *rawRom);
     ...
     * otherwise.
     */
    static bool isColorOnly(uint8_t *rawRom);
     ...
     */
    static bool hasSGBFunctionality(uint8_t *rawRom);
     ...
     */
    static std::string getLicenseCode(uint8_t* rawRom, uint8_t *oldLicense);
     ...
     */
    static std::string getRomTypeString(uint8_t *rawRom);
     ...
     **/
    static void getRomSize(uint8_t *rawRom, int *romSize, int *romBanks);
     ...
     */
    static void getRamSize(uint8_t *rawRom, int *ramSize, int *ramBanks);
     ...
     */
    static bool isJapanese(uint8_t *rawRom);
     ...
     */
    static int getMaskRomVersion(uint8_t *rawRom);
     ...
     * \param rawRom Contents of the Game Boy rom.
     */
    static bool hasValidHeaderSum(uint8_t *rawRom);
     ...
     */
    static bool hasValidGlobalSum(uint8_t *rawRom, int romSize);
};
